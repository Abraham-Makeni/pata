    ...
    <div className="min-h-screen bg-chalk">
      ...
      <div className="fixed bottom-24 right-5 flex flex-col gap-3 z-30">
        ...
        <button
          ...
          className="w-14 h-14 bg-green-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 transition-all hover:scale-105"
        ...
        <button
          ...
          className="w-14 h-14 bg-blue-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-blue-600 transition-all hover:scale-105"
          title="Call Now"
        >
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
